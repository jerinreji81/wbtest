...
const PHASE = 'Phase 2b - L8';
const VERSION = 'Phase 2b - L8';
...
const gates = {
  ...
  phaseVersionInConstants: constantsText.includes("var VERSION='Phase 2b - L8'"),
  phaseVersionInDist: distHtml.includes('Phase 2b - L8'),

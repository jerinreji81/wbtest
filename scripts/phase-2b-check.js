...
const PHASE = 'Phase 2b - QA2';
const VERSION = 'Phase 2b - QA2';
...
const gates = {
  ...
  phaseVersionInConstants: constantsText.includes("var VERSION='Phase 2b - QA2'"),
  phaseVersionInDist: distHtml.includes('Phase 2b - QA2'),
